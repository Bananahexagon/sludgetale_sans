...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core */ \"./src/core.ts\");\n/* harmony import */ var _lib_canvas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/canvas */ \"./src/lib/canvas.ts\");\n/* harmony import */ var _box__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./box */ \"./src/box.ts\");\n/* harmony import */ var _bone__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bone */ \"./src/bone.ts\");\n/* harmony import */ var _font__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./font */ \"./src/font.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\n\nwindow.onload = () => __awaiter(void 0, void 0, void 0, function* () {\n    yield _core__WEBPACK_IMPORTED_MODULE_0__.Core.init();\n    const cLib = (0,_lib_canvas__WEBPACK_IMPORTED_MODULE_1__.cLibGen)(_core__WEBPACK_IMPORTED_MODULE_0__.Core.ctx, _core__WEBPACK_IMPORTED_MODULE_0__.Core.Images);\n    cLib.stamp(\"bananahexagon\", 60, 160);\n    const Box = (0,_box__WEBPACK_IMPORTED_MODULE_2__.boxFnsGen)(cLib);\n    const Bone = (0,_bone__WEBPACK_IMPORTED_MODULE_3__.boneFnsGen)(cLib);\n    const Font = (0,_font__WEBPACK_IMPORTED_MODULE_4__.fontFnsGen)(cLib, _core__WEBPACK_IMPORTED_MODULE_0__.Core.inputKeys);\n    let Game = {\n        player: {\n            x: 0,\n            y: 0,\n        }\n    };\n    const update = () => {\n        _core__WEBPACK_IMPORTED_MODULE_0__.Core.ctx.clearRect(0, 0, _core__WEBPACK_IMPORTED_MODULE_0__.Core.canvas.width, _core__WEBPACK_IMPORTED_MODULE_0__.Core.canvas.height);\n        if (_core__WEBPACK_IMPORTED_MODULE_0__.Core.inputKeys.up)\n            Game.player.y -= 3;\n        if (_core__WEBPACK_IMPORTED_MODULE_0__.Core.inputKeys.down)\n            Game.player.y += 3;\n        if (_core__WEBPACK_IMPORTED_MODULE_0__.Core.inputKeys.left)\n            Game.player.x -= 3;\n        if (_core__WEBPACK_IMPORTED_MODULE_0__.Core.inputKeys.right)\n            Game.player.x += 3;\n        cLib.stamp(\"soul\", Game.player.x, Game.player.y);\n        console.clear();\n        console.log(_core__WEBPACK_IMPORTED_MODULE_0__.Core.inputKeys);\n        window.requestAnimationFrame(update);\n    };\n    window.requestAnimationFrame(update);\n});\n\n\n//# sourceURL=webpack://ut_battle_engine_ts/./src/index.ts?");
